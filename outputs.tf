output "vpc_id" {
  ...
  value       = concat(aws_vpc.added.*.id, [""])[0]
}

output "vpc_arn" {
  description = "The ARN of the VPC"
  value       = concat(aws_vpc.added.*.arn, [""])[0]
}

output "vpc_cidr_block" {
  description = "The CIDR block of the VPC"
  value       = concat(aws_vpc.added.*.cidr_block, [""])[0]
}

output "vpc_owner_id" {
  description = "The ID of the AWS account that owns the VPC"
  value       = concat(aws_vpc.added.*.owner_id, [""])[0]
}

output "vpc_main_route_table_id" {
  description = "The ID of the main route table associated with this VPC"
  value       = concat(aws_vpc.added.*.main_route_table_id, [""])[0]
}
...
#     value       = concat(aws_vpc.initial.*.default_security_group_id, [""])[0]
#   }
#   
#   output "default_network_acl_id" {
#     description = "The ID of the default network ACL"
#     value       = concat(aws_vpc.initial.*.default_network_acl_id, [""])[0]
#   }
#   
#   output "default_route_table_id" {
#     description = "The ID of the default route table"
#     value       = concat(aws_vpc.initial.*.default_route_table_id, [""])[0]
#   }
#   
#   output "vpc_instance_tenancy" {
#     description = "Tenancy of instances spin up within VPC"
#     value       = concat(aws_vpc.initial.*.instance_tenancy, [""])[0]
#   }
#   
#   output "vpc_enable_dns_support" {
#     description = "Whether or not the VPC has DNS support"
#     value       = concat(aws_vpc.initial.*.enable_dns_support, [""])[0]
#   }
#   
#   output "vpc_enable_dns_hostnames" {
#     description = "Whether or not the VPC has DNS hostname support"
#     value       = concat(aws_vpc.initial.*.enable_dns_hostnames, [""])[0]
#   }
#   
#   #output "vpc_ipv6_association_id" {
#   #  description = "The association ID for the IPv6 CIDR block"
#   #  value       = concat(aws_vpc.initial.*.ipv6_association_id, [""])[0]
#   #}
#   #
#   #output "vpc_ipv6_cidr_block" {
#   #  description = "The IPv6 CIDR block"
#   #  value       = concat(aws_vpc.initial.*.ipv6_cidr_block, [""])[0]
#   #}
#   #
...
#   #?  value       = aws_route_table_association.to_public.*.id
#   #?}
#   
#   #output "nat_ids" {
...
#     value       = concat(aws_internet_gateway.public.*.id, [""])[0]
#   }
#   
#   output "igw_arn" {
#     description = "The ARN of the Internet Gateway"
#     value       = concat(aws_internet_gateway.public.*.arn, [""])[0]
#   }
#   
